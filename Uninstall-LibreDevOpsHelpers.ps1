...
Write-Host ("OK {0}" -f ($removed ? "Removed $removed folder(s) from PSModulePath" : 'No residual folders found.'))
...
Write-Host "`nDone: LibreDevOpsHelpers has been fully removed. Restart PowerShell to flush auto-loaded commands."