...
# Script module or binary module file associated with this manifest.
    ...
    NestedModules = @(
        ...
        'LibreDevOpsHelpers.Splunk/LibreDevOpsHelpers.Splunk.psm1',
